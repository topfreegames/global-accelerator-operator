...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EndpointGroupPorts) DeepCopyInto(out *EndpointGroupPorts) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EndpointGroupPorts.
func (in *EndpointGroupPorts) DeepCopy() *EndpointGroupPorts {
	if in == nil {
		return nil
	}
	out := new(EndpointGroupPorts)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EndpointGroupStatus) DeepCopyInto(out *EndpointGroupStatus) {
	*out = *in
	if in.Ports != nil {
		...
		*out = make([]EndpointGroupPorts, len(*in))
		copy(*out, *in)
	}
}
